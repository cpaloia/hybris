    ...
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule,
            ...
            router_1.RouterModule.forRoot([
                { path: 'hybris', component: product_list_component_1.ProductListComponent },
                { path: 'contributors/:url',
                    canActivate: [product_guard_service_1.ProductDetailGuard], component: product_detail_component_1.ProductDetail },
